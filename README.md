...
ClipWave is a TikTok-style platform: creators upload short videos with
...
| MinIO console | http://localhost:9001 (login: `clipwave` / `clipwave_secret`) |

**Demo creator login:** `creator@clipwave.local` / `CreatorPass123!`
