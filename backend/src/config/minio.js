...
const minioClient = new Minio.Client({
  ...
  useSSL: false,
  accessKey: process.env.MINIO_ACCESS_KEY || 'clipwave',
  secretKey: process.env.MINIO_SECRET_KEY || 'clipwave_secret',
});

const VIDEO_BUCKET = process.env.MINIO_BUCKET || 'clipwave-videos';
